...
.statBox{padding:16px;border-radius:18px;background:rgba(255,255,255,.03);display:grid;gap:8px;text-align:center}
.statBox strong{color:var(--text-primary);font-size:20px;line-height:1.2}
...
.rangeItem{padding:16px;border-radius:18px;background:rgba(255,255,255,.03);display:grid;gap:8px}
.rangeItem span{color:var(--text-secondary);font-size:12px;line-height:1.4}
.rangeItem strong{color:var(--text-primary);line-height:1.35}
.progressWrap{margin-top:18px;padding:16px;border-radius:18px;background:rgba(255,255,255,.03)}
.progressLabel{margin-bottom:12px;color:var(--text-primary);font-size:13px;font-weight:600}
.balanceCard{padding:16px;border-radius:18px;background:rgba(255,255,255,.03);display:grid;gap:8px}
.balanceCard span{color:var(--text-secondary);font-size:12px;line-height:1.4}
.balanceCard strong{color:var(--text-primary);font-size:18px;line-height:1.3}
...
.amountSuffix{color:var(--text-secondary);font-weight:700}
