  ...
  <div class="pageShell">
    ...
    <div class="pageWrap px-3 pb-6">
      <div class="heroCard mt-4">
        <div class="sectionSubtext">{{ $t('theme.fundRecord') }}</div>
...
.heroCard {
  padding: 18px; border-radius: 24px; background: var(--gradient-hero);
...
.tabChip.active { background: rgba(95,224,179,0.12); color: var(--brand-primary); }
...
.dialogCard {
  width: min(350px, 100%); border-radius: 24px; background: radial-gradient(circle at top right, rgba(95, 224, 179, 0.12), transparent 30%), linear-gradient(180deg, rgba(24, 33, 43, 0.98), rgba(13, 17, 23, 0.98));
  border: 1px solid var(--border-soft); box-shadow: var(--shadow-float);
}
