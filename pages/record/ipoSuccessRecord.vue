...
<style scoped>
.pageWrap,.sectionCard{min-height:auto}.pageWrap{min-height:calc(100vh - 60px)}
.heroCard{padding:18px;border-radius:24px;background:var(--gradient-hero);border:1px solid var(--border-soft);box-shadow:var(--shadow-float)}
.heroTitle{margin-top:8px;color:var(--text-primary);font-size:24px;font-weight:800}
...
.itemTitle{color:var(--text-primary);font-weight:700}.itemCode{margin-top:4px;color:var(--text-secondary);font-size:12px}
.detailList{display:grid;gap:8px;margin-top:14px}
.detailRow{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 12px;border-radius:14px;background:rgba(255,255,255,.03);color:var(--text-secondary);font-size:13px}
.detailRow strong{text-align:right}
</style>
