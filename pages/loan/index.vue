...
.overlayWrap{display:flex;align-items:center;justify-content:center}
.dialogCard{width:min(350px,100%);border-radius:24px;background:transparent;border:1px solid var(--overlay-panel-border);box-shadow:var(--overlay-panel-shadow)}
.dialogHead{position:relative;padding:20px 20px 12px}.dialogTitle{color:var(--text-primary);font-size:20px;font-weight:800}.closeBtn{position:absolute;right:14px;top:14px;width:40px;height:40px;display:inline-flex;align-items:center;justify-content:center;border-radius:999px;background:var(--surface-interactive-soft);border:1px solid var(--border-soft);color:var(--text-secondary);cursor:pointer;transition:transform var(--motion-fast),border-color var(--motion-fast),background-color var(--motion-fast)}
.dialogBody{padding:0 20px 20px}.detailRow{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;border-radius:14px;background:var(--surface-interactive-soft);color:var(--text-secondary);font-size:13px}.detailRow strong{color:var(--text-primary)}
.fieldLabel{color:var(--text-primary);font-size:15px;font-weight:700;line-height:1.4}.authInput{background:var(--surface-interactive-strong);border:1px solid var(--border-default);border-radius:18px}.authInput :deep(.van-field__body){min-height:52px}.authInput :deep(.van-field__control){color:var(--text-primary)}
.dialogActions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.disBtn{background:rgba(148,163,184,.24)!important;color:var(--text-muted)!important;box-shadow:none!important}
