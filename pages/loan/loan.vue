...
.overlayWrap{display:flex;align-items:center;justify-content:center}.dialogCard{width:min(350px,100%);border-radius:24px;background:transparent;border:1px solid var(--overlay-panel-border);box-shadow:var(--overlay-panel-shadow)}
...
.dialogBody{padding:0 20px 20px}.fieldLabel{color:var(--text-primary);font-size:15px;font-weight:700;line-height:1.4}.authInput{background:var(--surface-interactive-soft);border:1px solid var(--border-default);border-radius:18px}.authInput :deep(.van-field__body){min-height:52px}.authInput :deep(.van-field__control){color:var(--text-primary)}
